...
class blocksocial extends Module
{
	...
	public function install()
	{
		return (parent::install() AND 
                        ...
                        Configuration::updateValue('blocksocial_tuenti', '') && 
	...
	public function uninstall()
	{
		...
		return (Configuration::deleteByName('blocksocial_facebook') AND 
                        ...
                        Configuration::deleteByName('blocksocial_tuenti') AND 
	...
	public function getContent()
	{
		...
		{	
			...
			Configuration::updateValue('blocksocial_youtube', (($_POST['youtube_url'] != '') ? $_POST['youtube_url']: ''));		
			Configuration::updateValue('blocksocial_tuenti', (($_POST['tuenti_url'] != '') ? $_POST['tuenti_url']: ''));		
		...
		<form action="'.Tools::htmlentitiesutf8($_SERVER['REQUEST_URI']).'" method="post">
			<fieldset class="width2">				
				...
				<input type="text" id="youtube_url" name="youtube_url" value="'.Tools::safeOutput((Configuration::get('blocksocial_youtube') != "") ? Configuration::get('blocksocial_youtube') : "").'" />
				<div class="clear">&nbsp;</div>		
				<label for="tuenti_url">'.$this->l('Tuenti URL: ').'</label>
				<input type="text" id="tuenti_url" name="tuenti_url" value="'.Tools::safeOutput((Configuration::get('blocksocial_tuenti') != "") ? Configuration::get('blocksocial_tuenti') : "").'" />
				<div class="clear">&nbsp;</div>		
	...
	public function hookDisplayFooter()
	{
		...
		$smarty->assign(array(
			...
			'tuenti_url' => Configuration::get('blocksocial_tuenti'),
