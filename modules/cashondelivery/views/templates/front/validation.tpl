...
<form action="{$link->getModuleLink('cashondelivery', 'validation', [], true)}" method="post">
	...
	<p class="cart_navigation">
		<a href="{$link->getPageLink('order', true)}?step=3" class="button_large" id="cart_navigation_continue">{l s='Other payment methods' mod='cashondelivery'}</a>
		<input type="submit" name="submit" value="{l s='I confirm my order' mod='cashondelivery'}" class="exclusive_large" id="cart_navigation_next" />
	</p>
</form>
