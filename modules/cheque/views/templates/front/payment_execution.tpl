...
{else}
    ...
    <fieldset class="order_carrier_content" style="margin: 0px auto;max-width: 500px;">
        <h3 class="cabeceraseccion">{l s='Cheque payment' mod='cheque'}</h3>
        <div class="order_carrier_body">
                    ...
                    <p class="cart_navigation">
                            <input type="submit" name="submit" value="{l s='I confirm my order' mod='cheque'}" class="exclusive_large" id="cart_navigation_continue" />
                            <a href="{$link->getPageLink('order', true, NULL, "step=3")}" class="button_large" id="cart_navigation_next">{l s='Other payment methods' mod='cheque'}</a>
                    </p>
            </form>
    {/if}
