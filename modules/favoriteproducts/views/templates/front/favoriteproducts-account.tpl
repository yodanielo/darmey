...
<div id="favoriteproducts_block_account">
	...
	{/if}
        ...
        <p class="cart_navigation">
            <a href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}" id="cart_navigation_continue"><img src="{$img_dir}icon/my-account.gif" alt="" class="icon" />{l s="Home"}</a>
            <a href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}" id="cart_navigation_next">{l s='Back to Your Account' mod='favoriteproducts'}</a>
        </p>
</div>