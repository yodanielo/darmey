...
<fieldset class="order_carrier_content" style="margin: 0px auto;max-width: 500px;">
	<h3 class="cabeceraseccion">{l s='PayPal payment' mod='paypal'}</h3>
        <div class="order_carrier_body">
                    ...
                    <p class="cart_navigation">
                            <input type="submit" name="confirmation" value="{l s='I confirm my order' mod='paypal'}" class="exclusive_large" id="cart_navigation_next" />
                    </p>
            </form>
{/if}
