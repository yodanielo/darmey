...
<div class="clear address_add"><a href="{$link->getPageLink('address', true)}" title="{l s='Add an address'}" class="btn">{l s='Add an address'}</a></div>

<p class="cart_navigation">
	<a href="{$base_dir}" id="cart_navigation_continue"><img src="{$img_dir}icon/home.gif" alt="" class="icon" /> {l s='Home'}</a>
	<a href="{$link->getPageLink('my-account', true)}" id="cart_navigation_next" ><img src="{$img_dir}icon/my-account.gif" alt="" class="icon" /> {l s='Back to your account'}</a>
</p>
