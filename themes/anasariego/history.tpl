...
<div class="block-center" id="block-history">
	...
	<table id="order-list" class="std">
		<thead>
			<tr>
				<th class="first_item cabeceratable">{l s='Order Reference'}</th>
				<th class="item cabeceratable">{l s='Date'}</th>
				<th class="item cabeceratable">{l s='Total price'}</th>
				<th class="item cabeceratable">{l s='Payment'}</th>
				<th class="item cabeceratable">{l s='Status'}</th>
				<th class="item cabeceratable">{l s='Invoice'}</th>
				<th class="last_item cabeceratable" style="width:65px">&nbsp;</th>
			</tr>
		</thead>
		<tbody>
