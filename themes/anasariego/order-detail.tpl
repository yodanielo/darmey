...
<h3 class="cabeceraseccion">{l s='Follow your order step-by-step'}</h3>
<div class="table_block order_carrier_body">
	<table class="detail_step_by_step std">
		<thead>
			<tr>
				<th class="first_item cabeceratable">{l s='Date'}</th>
				<th class="last_item cabeceratable">{l s='Status'}</th>
			</tr>
		</thead>
		<tbody>
...
<ul class="address item {if $order->isVirtual()}full_width{/if}">
	<li class="address_title first_item cabeceratable">{l s='Billing'}</li>
...
<ul class="address alternate_item" {if $order->isVirtual()}style="display:none;"{/if}>
	<li class="address_title last_item cabeceratable">{l s='Delivery'}</li>
	...
	<table class="std">
		<thead>
			<tr>
				...
				<th class="{if $return_allowed}item{else}first_item{/if} cabeceratable">{l s='Reference'}</th>
				<th class="item cabeceratable">{l s='Product'}</th>
				<th class="item cabeceratable">{l s='Quantity'}</th>
				{if $order->hasProductReturned()}
					<th class="item cabeceratable">{l s='Returned'}</th>
				{/if}
				<th class="item cabeceratable">{l s='Unit price'}</th>
				<th class="last_item cabeceratable">{l s='Total price'}</th>
			</tr>
		</thead>
		<tfoot>
...
{if $order->getShipping()|count > 0}
	<table class="std">
		<thead>
			<tr>
				<th class="first_item cabeceratable">{l s='Date'}</th>
				<th class="item cabeceratable">{l s='Carrier'}</th>
				<th class="item cabeceratable">{l s='Weight'}</th>
				<th class="item cabeceratable">{l s='Shipping cost'}</th>
				<th class="last_item cabeceratable">{l s='Tracking number'}</th>
			</tr>
		</thead>
		<tbody>
...
{if !$is_guest}
	...
	<div id="returnOrderMessage">
		<h3 class="cabeceraseccion">{l s='Merchandise return'}</h3>
	...
	<div class="table_block">
		<table class="detail_step_by_step std">
			<thead>
				<tr>
					<th class="first_item cabeceratable" style="width:150px;">{l s='From'}</th>
					<th class="last_item cabeceratable">{l s='Message'}</th>
				</tr>
			</thead>
			<tbody>
	...
	<form action="{$link->getPageLink('order-detail', true)}" method="post" class="std" id="sendOrderMessage">
		<h3 class="cabeceraseccion" style="padding-bottom: 0px;margin-bottom: 20px;">{l s='Add a message:'}</h3>
